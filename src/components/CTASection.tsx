...
const CTASection = () => {
  ...
  return (
    <section className="py-20 bg-darkgray relative overflow-hidden slide border-orange-glow" ref={sectionRef}>
      <div className="absolute inset-0 bg-[url('/src/assets/grid-pattern.svg')] opacity-10"></div>
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a href="#contact" className="bg-orange text-white font-medium py-3 px-8 rounded-md hover:bg-orange-light transition-colors duration-300">
              Get in Touch
            </a>
